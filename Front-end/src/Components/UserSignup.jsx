...
const UserSignup = () => {
  ...
  const { mutate, isLoading } = useMutation({
    mutationFn: () => signup(userDetails.email, userDetails.password),
    ...
    <section>
        <div className="flex">
            <div className="basis-[60%]  ">
                <div className="bg-white w-[450px] h-[530px] mx-auto mt-12 rounded-xl shadow-2xl">
